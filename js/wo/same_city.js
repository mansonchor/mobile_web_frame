define("wo/same_city",["base_package",'frame_package',"btn_package","commom_function","wo_config","get_template","footer_view","slider",'notice','world_list_module'],function(require, exports)
{
	var $ = require('zepto')
	...
	exports.route = { "same_city/:id": "same_city"  }
	...
	exports.new_page_entity = function()
	{
		...
		{  
			...
			var init_html = '<div class="wrap-box"><header class="header fb re font_wryh"><h1 class="logo">同城照片</h1></header><div class="content-10 main_wraper" ><div class="index-page"  style="padding-top:45px;"><!-- fixed 列表滚动闪烁bug --><div  style="overflow:hidden;position:relative;z-index: 1;"><div style="-webkit-transform:translateZ(0px);" ></div></div><!-- fixed 列表滚动闪烁bug --><div class="main_container"></div></div></div></div>'
		...
		{		
			...
			world_list_module_obj = new world_list_module({ 
				url : wo_config.ajax_url.same_city+"?location_id="+location_id,
				list_type : "photowall",
