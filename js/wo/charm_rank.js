/*
    hdw 魅力榜
*/
define("wo/charm_rank",["base_package",'frame_package',"btn_package","commom_function","wo_config","get_template","rank_nav","select_module","notice"],function(require, exports)
{
	var $ = require('zepto')
	...
	exports.route = { "charm_rank(/:time)": "charm_rank" }

	exports.new_page_entity = function()
	{
		var options = {		
			title : "魅力排行榜",
			route : { "charm_rank": "charm_rank" },
		...
		var charm_rank_collection_obj
		var charm_rank_view_obj
                    ...
                    if (!city_select_obj)
                    {
                        ...
                        city_select_obj = new select_module_class(
                        {
                            ...
                            onchange : function()
                            {
                                ...
                                charm_rank_collection_obj.refresh()
		...
		//数据model
    	var charm_rank_model = Backbone.Model.extend
        ({
    		defaults:
    		{
		...
		var charm_rank_collection = Backbone.Collection.extend
        ({
            model : charm_rank_model,    
			url : wo_config.ajax_url.get_charm_expense_rank_list,

		    refresh : function()
			{
				var that = this
				collection_options.data = { date_type : cur_type , rank_type : "charm" , location_city : cur_city}
		...
		//魅力榜列表视图
        var charm_rank_view = Backbone.View.extend
        ({
    		  tagName: "ul",
    		  className: "rank_item",
		...
		{		
            ...
            var init_html = '<div class="wrap-box"><header class="header font_wryh fb tc re "><h3 class="tc" >魅力榜</h3></header><div class="main_wraper"><div class="inside-page font_wryh" style="padding-top:45px;"><div style="overflow:hidden;position:relative;z-index: 1;"><div style="-webkit-transform:translateZ(0px);"></div></div><div class="main_container"><div class="list-page pl10 pr10"><div class="select-city-data clearfix mt10 color666"><div class="location_city bgcf0f border-style-be re fl radius-2px" data_select_location style="display:none"><span data_city_value class="city fl"></span><em class="fl ml20 icon-change mt5"></em></div><div class="data-list-change fr radius-2px"><ul class="clearfix"><li class="cur" data_select_date="day">日榜</li><li data_select_date="week">周榜</li></ul></div></div><div class="list-item pt10 pb15" day_list_charm_rank></div><div class="list-item pt10 pb15" week_list_charm_rank style="display:none"></div></div></div></div></div></div>'
		...
		{
            window.localStorage.setItem("rank_nav_address","charm_rank"); 
		...
		options.page_init = function(page_view,params_arr,params_obj)
		{
		    ...
		    */ 
			...
			charm_rank_collection_obj = new charm_rank_collection
			
			charm_rank_collection_obj.bind('reset', re_render_list , page_view)
        ...
        function re_render_list()
		{
			...
			charm_rank_collection_obj.each(function(item_model)
			{
				var charm_rank_view_obj = new charm_rank_view	
				({
                    model : item_model
                })	
				if(cur_type == 'day')
			    {
				  day_list_controller_obj.add_list_item(charm_rank_view_obj)
			    }
			    else if(cur_type == 'week')
			    {
				  week_list_controller_obj.add_list_item(charm_rank_view_obj)
